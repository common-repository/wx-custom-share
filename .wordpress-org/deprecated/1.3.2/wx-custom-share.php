                	...
                	<div class="ws-timeline clearfix">
                        ...
                        <div class="ws-timeline-right">
                            ...
                            <a href="<?php echo get_permalink($post) ?>" target="_blank">
                    			...
                    			<td><img class="ws-link-img" src="<?php echo $meta ? $meta_url . urlencode( esc_url($meta)) : $pngdata ?>" alt="<?php _e('cannot get the image','wx-custom-share') ?>"></td>
                    ...
                    <div class="ws-chat clearfix">
                    	...
                    	<div class="ws-chat-main">
                            ...
                            <div class="ws-chat-desc-div">
                            	...
                            	<img class="ws-link-img" src="<?php echo $meta ? $meta_url . urlencode( esc_url($meta) ) : $pngdata ?>" alt="<?php _e('cannot get the image','wx-custom-share') ?>" style="float:right;">
                            </div>
                        </div>
                        </div>
						</a>
...
function wxcs_show(){
	if( is_singular() ):
		...
		if( '' !== $ws_settings['ws_display_types'] && array_key_exists( get_post_type(), $ws_settings['ws_display_types'] ) ):
			...
			if( $meta ):
				$ws_url = admin_url( 'admin-ajax.php' ) . '?action=resizeimg&s=' . urlencode( esc_url($meta) );
?>
