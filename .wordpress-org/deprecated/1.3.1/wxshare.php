                	...
                	<div class="ws-timeline clearfix">
                        ...
                        <div class="ws-timeline-right">
                            ...
                            <a href="<?php echo get_permalink($post) ?>" target="_blank">
                    			...
                    			<td><img class="ws-link-img" src="<?php echo $meta ? $meta_url . urlencode( esc_url($meta)) : $pngdata ?>" alt="<?php _e('cannot get the image','wxshare') ?>"></td>
                    ...
                    <div class="ws-chat clearfix">
                    	...
                    	<div class="ws-chat-main">
                            ...
                            <div class="ws-chat-desc-div">
                            	...
                            	<img class="ws-link-img" src="<?php echo $meta ? $meta_url . urlencode( esc_url($meta) ) : $pngdata ?>" alt="<?php _e('cannot get the image','wxshare') ?>" style="float:right;">
                            </div>
                        </div>
                        </div>
						</a>
